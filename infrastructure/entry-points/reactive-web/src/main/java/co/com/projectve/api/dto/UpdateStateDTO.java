...
public record UpdateStateDTO (
        ...
        @Schema(description = "id del prestamo", example = "17")
        @NotNull(message = "El id del prestamo es obligatorio")
        Integer idRequest,

        @Schema(description = "Correo electrónico único del usuario", example = "librecarbon@gmail.com", requiredMode = Schema.RequiredMode.REQUIRED, format = "email")
